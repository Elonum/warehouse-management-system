...
func (r *ShipmentStatusRepository) GetByID(ctx context.Context, statusID uuid.UUID) (*ShipmentStatus, error) {
	query := `
		SELECT shipment_status_id, name, is_final
...
func (r *ShipmentStatusRepository) Create(ctx context.Context, name string, isFinal bool) (*ShipmentStatus, error) {
	query := `
		INSERT INTO shipment_statuses (name, is_final)
		VALUES ($1, $2)
		RETURNING shipment_status_id, name, is_final
	`
...
func (r *ShipmentStatusRepository) Update(ctx context.Context, statusID uuid.UUID, name string, isFinal bool) (*ShipmentStatus, error) {
	query := `
...
func (r *ShipmentStatusRepository) Delete(ctx context.Context, statusID uuid.UUID) error {
	query := `
