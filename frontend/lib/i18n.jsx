...
const translations = {
  ru: {
    ...
    nav: {
      ...
      warehouses: 'Склады',
      stock: 'Остатки',
      stockSnapshots: 'Снимки остатков',
    ...
    productCosts: {
      title: 'Себестоимость',
      description: 'Периоды себестоимости до склада по товарам',
      titleHint:
        'Себестоимость действует в указанном периоде. Пустая дата окончания — период открыт (текущий). При добавлении нового периода предыдущий открытый закрывается автоматически. Не пересекающиеся периоды на один товар обязательны.',
      addPeriod: 'Добавить период',
      editPeriod: 'Редактировать период',
      searchPlaceholder: 'Поиск себестоимости',
      emptyMessage: 'Периоды себестоимости не найдены',
      paginationNav: 'Страницы себестоимости',
      unknownProduct: 'Товар {id}',
      currentPeriod: 'Открытый период',
      activeBadge: 'Действует',
      barcodeLabel: 'Баркод',
      linkFromProducts: 'Себестоимость',
      viewJournal: 'Все периоды',
      viewActive: 'Действующие',
      stats: {
        total: 'Записей',
        active: 'Действующих',
        products: 'Товаров',
      ...
      quality: {
        overlapPairs: 'Пересекающиеся периоды: {count} пар. Проверьте корректность данных.',
      },
      missing: {
        title: 'Товары без себестоимости',
        description: 'Товары с остатком, для которых нет действующего периода себестоимости до склада.',
        emptyMessage: 'Товаров без себестоимости не найдено',
        stats: {
          total: 'Товаров без себестоимости',
        },
        openReport: 'Отчёт: без себестоимости',
        backToPeriods: 'К периодам',
        table: {
          product: 'Товар',
          totalQuantity: 'Остаток',
          warehouseCount: 'Складов',
        },
        actions: {
          openStock: 'Открыть остатки',
          openCosts: 'Открыть себестоимость',
        },
      },
      filters: {
        title: 'Фильтры:',
      ...
      meta: {
        createdAtHint: 'Кем и когда создан период',
        updatedAtHint: 'Кем и когда обновлён период',
      },
      form: {
        ...
        periodEndHint: 'Оставьте пустым для открытого (текущего) периода',
        unitCostRequired: 'Себестоимость до склада (₽) *',
        closePrevious: 'Закрыть предыдущий открытый период',
        closePreviousHint: 'Дата окончания предыдущего периода = день до начала нового',
        notes: 'Примечания',
        notesPlaceholder: 'Комментарий к периоду',
      },
      deleteConfirm: {
        title: 'Удалить период',
        description: 'Удалить этот период себестоимости? Действие нельзя отменить.',
      },
      errors: {
        createFailed: 'Не удалось создать период себестоимости',
        updateFailed: 'Не удалось обновить период себестоимости',
        deleteFailed: 'Не удалось удалить период себестоимости',
        costExists: 'Такой период уже существует',
        periodOverlap: 'Период пересекается с существующим для этого товара',
        invalidDateRange: 'Дата окончания должна быть не раньше даты начала',
        productNotFound: 'Товар не найден',
        invalidCost: 'Себестоимость не может быть отрицательной',
      },
    },
    products: {
      title: 'Товары',
    ...
    stock: {
      ...
      stats: {
        ...
        warehouse: 'Склад',
        totalStockValue: 'Стоимость остатков (₽)',
        rowsMissingCost: 'Позиций без себестоимости',
        rowsWithCost: 'Позиций с себестоимостью',
      },
      filters: {
        title: 'Фильтры:',
        product: 'Товар',
        ...
        levelMissingCost: 'Без себестоимости',
        clear: 'Очистить фильтры',
      },
      table: {
        product: 'Товар',
    ...
    stockSnapshots: {
      ...
      description:
        'Базовые точки учёта остатков по товару и складу. От них считается текущий остаток и движения после даты снимка.',
      searchPlaceholder: 'Поиск снимков остатков...',
      titleHint:
        'Снимок — зафиксированное количество на дату по паре «товар + склад». Текущий остаток = последний снимок + движения после его даты. Режим «Актуальные по паре» — только последние снимки (для сверки с остатками). «Все снимки» — полная история.',
      emptyMessage: 'Снимки не найдены',
      paginationNav: 'Страницы журнала снимков',
      unknownProduct: 'Товар {id}',
      unknownWarehouse: 'Склад {id}',
      viewJournal: 'Все снимки',
      viewLatest: 'Актуальные по паре',
      stats: {
        total: 'Записей',
        pairs: 'Пар товар–склад',
        dateFrom: 'С даты',
        dateTo: 'По дату',
      },
      filters: {
      ...
      detail: {
        title: 'Снимок остатка',
        snapshotId: 'ID снимка',
        openMovements: 'Движения после снимка',
        openStock: 'Текущий остаток',
      },
      linkFromStock: 'Снимки',
    },
    stockMovements: {
  ...
  en: {
    ...
    productCosts: {
      title: 'Product costs',
      description: 'Unit cost-to-warehouse periods per product',
      titleHint:
        'Cost applies within the date range. Empty end date means an open (current) period. Adding a new period auto-closes the previous open one. Periods for the same product must not overlap.',
      addPeriod: 'Add period',
      editPeriod: 'Edit period',
      searchPlaceholder: 'Search product costs',
      emptyMessage: 'No cost periods found',
      paginationNav: 'Product costs pagination',
      unknownProduct: 'Product {id}',
      currentPeriod: 'Open period',
      activeBadge: 'Active',
      barcodeLabel: 'Barcode',
      linkFromProducts: 'Costs',
      viewJournal: 'All periods',
      ...
      quality: {
        overlapPairs: 'Overlapping cost periods: {count} pairs. Please verify data quality.',
      },
      missing: {
        title: 'Products without unit cost',
        description: 'Products with stock but without an active unit cost period to the warehouse.',
        emptyMessage: 'No products without unit cost found',
        stats: {
          total: 'Products without unit cost',
        },
        openReport: 'Report: without unit cost',
      ...
      meta: {
        createdAtHint: 'Who and when the period was created',
        updatedAtHint: 'Who and when the period was last updated',
      },
      form: {
        ...
        periodEndHint: 'Leave empty for an open (current) period',
        unitCostRequired: 'Cost to warehouse (₽) *',
        closePrevious: 'Close previous open period',
        closePreviousHint: 'Previous period end date = day before new start',
        notes: 'Notes',
        notesPlaceholder: 'Period comment',
      },
      deleteConfirm: {
        title: 'Delete period',
        description: 'Delete this cost period? This cannot be undone.',
      },
      errors: {
        createFailed: 'Failed to create cost period',
        updateFailed: 'Failed to update cost period',
        deleteFailed: 'Failed to delete cost period',
        costExists: 'This cost period already exists',
        periodOverlap: 'Period overlaps an existing one for this product',
        invalidDateRange: 'End date must be on or after start date',
        productNotFound: 'Product not found',
        invalidCost: 'Cost cannot be negative',
      },
    },
    products: {
      title: 'Products',
    ...
    stock: {
      ...
      stats: {
        ...
        rowsMissingCost: 'Rows without cost',
        rowsWithCost: 'Rows with cost',
      },
      filters: {
        title: 'Filters:',
        product: 'Product',
        ...
        levelMissingCost: 'Without unit cost',
        clear: 'Clear Filters',
      },
      table: {
        product: 'Product',
    ...
    stockSnapshots: {
      ...
      description:
        'Base stock points per product and warehouse. Current stock and post-snapshot movements are calculated from these.',
      searchPlaceholder: 'Search stock snapshots...',
      titleHint:
        'A snapshot is stock quantity on a date for a product–warehouse pair. Current stock = latest snapshot + movements after that date. «Latest per pair» shows only the newest snapshot per pair (compare with stock levels). «All snapshots» is full history.',
      emptyMessage: 'No snapshots found',
      paginationNav: 'Stock snapshots pagination',
      unknownProduct: 'Product {id}',
      unknownWarehouse: 'Warehouse {id}',
      viewJournal: 'All snapshots',
      viewLatest: 'Latest per pair',
      stats: {
        total: 'Records',
        pairs: 'Product–warehouse pairs',
        dateFrom: 'From date',
        dateTo: 'To date',
      },
      filters: {
      ...
      detail: {
        ...
        openMovements: 'Movements after snapshot',
        openStock: 'Current stock',
      },
      linkFromStock: 'Snapshots',
    },
    stockMovements: {
