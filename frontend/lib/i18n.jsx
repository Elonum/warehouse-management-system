...
const translations = {
  ru: {
    ...
    stockMovements: {
      ...
      description: 'Снимки зафиксированных остатков по нашим складам',
      snapshotHint: 'Полный журнал движений в разработке. Сейчас отображаются снимки остатков из системы.',
      searchPlaceholder: 'Поиск по товару или складу...',
      emptyMessage: 'Снимки остатков не найдены',
      unknownProduct: 'Товар {id}',
      unknownWarehouse: 'Склад {id}',
      filters: {
        title: 'Фильтры:',
  ...
  en: {
    ...
    stockMovements: {
      title: 'Stock history',
      description: 'Recorded stock snapshots for our warehouses',
      snapshotHint: 'A full movement journal is planned. Currently showing stock snapshots from the system.',
      searchPlaceholder: 'Search by product or warehouse...',
      emptyMessage: 'No stock snapshots found',
      unknownProduct: 'Product {id}',
      unknownWarehouse: 'Warehouse {id}',
      filters: {
        title: 'Filters:',
