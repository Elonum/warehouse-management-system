    ...
    shipments: {
      ...
      import: {
        ...
        wildberriesPageDescription:
          'Подтягивание принятых количеств из API FBW Supplies (поставки на склады WB) в выбранную отгрузку.',
        wbServerTokenHint:
          'На сервере должен быть задан WB_SUPPLIES_TOKEN (категория «Поставки» в личном кабинете WB). Базовый URL по умолчанию: supplies-api.wildberries.ru.',
        wbFieldShipment: 'Отгрузка в системе',
        wbShipmentPlaceholder: 'Выберите отгрузку',
        wbFieldSupplyId: 'Номер поставки WB (supply ID)',
        wbFieldMatchBy: 'Сопоставление с товаром',
        wbMatchBarcode: 'По штрихкоду карточки (barcode)',
        wbMatchVendorCode: 'По артикулу продавца (vendorCode = артикул)',
        wbIsPreorderID: 'ID в запросе — preorder (заказ), не поставка',
        wbPreview: 'Загрузить превью из WB',
        wbApply: 'Применить к отгрузке',
        wbSupplySummary: 'Поставка в WB',
        wbStatus: 'Код статуса',
        wbWarehouse: 'Склад',
        wbAcceptedTotal: 'Принято всего (шапка поставки)',
        wbWarnings: 'Предупреждения',
        wbLinesTitle: 'Строки отгрузки — что будет записано в «Принято»',
        wbColArticle: 'Артикул',
        wbColBarcode: 'Штрихкод',
        wbColSent: 'Отправлено',
        wbColCurrentAccepted: 'Сейчас принято',
        wbColImportAccepted: 'Импорт (принято)',
        wbColMatched: 'Есть данные WB',
        wbUnmatchedTitle: 'Строки WB без сопоставления с позициями отгрузки',
        wbColVendor: 'Арт. WB',
        wbColAccepted: 'Принято WB',
        wbListTitle: 'Поставки Wildberries',
        wbListHint:
          'Запрос через ваш сервер к WB (без отдельной таблицы в БД). По умолчанию — статусы 4–5 (приёмка / принято). Укажите период, чтобы сузить список.',
        wbListLoad: 'Загрузить список',
        wbListEmpty: 'Нет строк по фильтрам. Поменяйте даты или статусы на стороне WB; при необходимости введите ID вручную ниже.',
        wbDateFrom: 'Дата с',
        wbDateTill: 'Дата по',
        wbDateType: 'Тип даты в фильтре WB',
        wbDateTypeFact: 'Фактическая (factDate)',
        wbDateTypeSupply: 'Поставка (supplyDate)',
        wbDateTypeCreate: 'Создание (createDate)',
        wbListColImportId: 'ID для импорта',
        wbListColKind: 'Тип',
        wbListKindSupply: 'Поставка',
        wbListKindPreorder: 'Предзаказ',
        wbListColSupplyDate: 'Дата поставки',
        wbListColFactDate: 'Факт (WB)',
        wbListUse: 'Выбрать',
        wbDocFooter:
          'Документация: FBW Supplies на dev.wildberries.ru — список поставок и товары в поставке (acceptedQuantity).',
  ...
  en: {
    ...
    shipments: {
      ...
      import: {
        ...
        wildberriesPageDescription:
          'Pull accepted quantities from the FBW Supplies API into a marketplace shipment.',
        wbServerTokenHint:
          'The server must have WB_SUPPLIES_TOKEN set (Supplies scope in the WB seller account). Default host: supplies-api.wildberries.ru.',
        wbFieldShipment: 'Shipment in the app',
        wbShipmentPlaceholder: 'Choose shipment',
        wbFieldSupplyId: 'WB supply ID',
        wbFieldMatchBy: 'Match products by',
        wbMatchBarcode: 'Barcode (card barcode)',
        wbMatchVendorCode: 'Vendor code (= your article)',
        wbIsPreorderID: 'Treat ID as preorder (order), not supply',
        wbPreview: 'Load preview from WB',
        wbApply: 'Apply to shipment',
        wbSupplySummary: 'WB supply',
        wbStatus: 'Status code',
        wbWarehouse: 'Warehouse',
        wbAcceptedTotal: 'Accepted total (supply header)',
        wbWarnings: 'Warnings',
        wbLinesTitle: 'Shipment lines — values to write to “Accepted”',
        wbColArticle: 'Article',
        wbColBarcode: 'Barcode',
        wbColSent: 'Sent',
        wbColCurrentAccepted: 'Current accepted',
        wbColImportAccepted: 'Import (accepted)',
        wbColMatched: 'WB data matched',
        wbUnmatchedTitle: 'WB rows not matched to shipment lines',
        wbColVendor: 'WB vendor code',
        wbColAccepted: 'Accepted (WB)',
        wbListTitle: 'Wildberries supplies',
        wbListHint:
          'Fetched via your backend from WB (not stored in our DB). Defaults to statuses 4–5 (accepting / accepted). Use a date range to narrow results.',
        wbListLoad: 'Load list',
        wbListEmpty: 'No rows for these filters. Adjust dates or enter an ID manually below.',
        wbDateFrom: 'From',
        wbDateTill: 'To',
        wbDateType: 'WB date field',
        wbDateTypeFact: 'Fact date',
        wbDateTypeSupply: 'Supply date',
        wbDateTypeCreate: 'Create date',
        wbListColImportId: 'Import ID',
        wbListColKind: 'Kind',
        wbListKindSupply: 'Supply',
        wbListKindPreorder: 'Preorder',
        wbListColSupplyDate: 'Supply date',
        wbListColFactDate: 'Fact date',
        wbListUse: 'Use',
        wbDocFooter: 'Docs: FBW Supplies on dev.wildberries.ru — supplies list and goods (acceptedQuantity).',
